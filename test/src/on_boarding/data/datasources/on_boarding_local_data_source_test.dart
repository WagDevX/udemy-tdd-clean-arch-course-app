...
void main() {
  ...
  group('cacheFirstTimer', () {
    ...
    test(
        'should throw a [CacheExpection] when there '
      ...
      expect(methodCall, throwsA(isA<CacheExpection>()));
  ...
  group('checkIfUserIsFirstTimer', () {
    ...
    test(
      ...
      final methodToCall = localDataSource.checkIfUserIsFirstTimer;

      expect(methodToCall, throwsA(isA<CacheExpection>()));
      verify(() => prefs.getBool(kFirstTimerKey)).called(1);
      verifyNoMoreInteractions(prefs);
    });
  });
