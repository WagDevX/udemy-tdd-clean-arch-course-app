...
void main() {
  ...
  group('forgotPassword', () {
    test('should complete successfuly when no [Exception] is thrown', () async {
    ...
    test(
        'should thrown a [ServerExpection] when [FirebaseAuthExpection] '
        'is thrown', () async {
      when(() => authClient.sendPasswordResetEmail(email: any(named: 'email')))
  ...
  group('signIn', () {
    test('should return a [LocalUserModel] when no exeption is trown',
        () async {
      when(
    ...
    test(
        'should throw an [ServerException] when [FirebaseAuthException] is '
        'thrown', () async {
      when(
        () => authClient.signInWithEmailAndPassword(
          email: any(named: 'email'),
    ...
    test('should throw a [ServerException] when user is null after signing in',
        () async {
  ...
  group('updateUser', () {
    ...
    test(
        'should update user displayName successfuly when no [Exception] is '
        'thrown', () async {
      when(() => mockUser.updateDisplayName(any()))
          .thenAnswer((async) async => Future.value());
    ...
    test(
        'should update user email successfuly when no [Exception] is '
        'thrown', () async {
    ...
    test(
        'should update user bio successfuly when no [Exception] is '
        'thrown', () async {
    ...
    test(
        'should update user profilePic successfuly when no [Exception] is '
        'thrown', () async {
